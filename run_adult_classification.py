...
if __name__ == "__main__":
    approx_methods = [
        ...
        # dist_type sets the sampling distribution over coalition sizes: paper for the theoretically derived one, uniform for the uniform distribution
        # smart_factor speeds up the sampling process without replacement by changing from a list of sampled coalitions to a list of coalitions to sample, values between 0.2 and 0.8 are reasonable, has no effect on the approximation
    ...
    game_list = []
    used_ids = set()
    data_folder = "adult_classification_1"
