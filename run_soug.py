...
from Games.SOUG import SOUG

from Games.SparseLinearModels import SparseLinearModel
...
if __name__ == "__main__":
    ...
    # SOUG game ------------------------------------------------------------------------------------
    game_list = [
        SOUG(number_of_players=20, set_number=50) for _ in range(NUMBER_OF_RUNS)
    ]
